...
//    randomSeed(1234);
    ...
    sliders[7] = createSlider(0.5,10,1,0.5);
...
function mousePressed () {
    if(mouseX < 800) {
        for (var ctr = 0; ctr < caali.length; ctr++) {
            if(dist(mouseX, mouseY, caali[ctr].x, caali[ctr].y) < (caali[ctr].energy + 100)/20) {
